...
export default function MortgageTypePage() {
  ...
  const title = "3-Year Fixed Mortgage Rates Canada 2026 — Compare Best Rates";
  const desc = "Compare the best 3-year fixed mortgage rates in Canada for 2026. Current best rate: 3.99%. The middle-ground between flexibility and certainty.";
  const h1 = "3-Year Fixed Mortgage Rates in Canada — 2026";
  const intro = "A 3-year fixed mortgage offers a middle ground between the flexibility of a 1-year term and the certainty of a 5-year. Popular in 2026 as buyers hedge against rate movements. Compare 3-year fixed rates from banks, credit unions, and online lenders.";
  const bestRate = "3.99%";
  const rateKey = "fixedRate";
  const slug = "3-year-fixed";
