...
const OFFERS=[
  ...
  {bank:"nesto",type:"Rate",badge:"📉 Rate Special",color:"#2563eb",textColor:"#fff",offer:"Canada's Lowest Rates Guaranteed",detail:"nesto offers a lowest rate guarantee — if you find a lower rate elsewhere, they'll beat it. No broker fees, fully digital, and fast approvals.",expires:"Ongoing",url:"https://www.nesto.ca",tag:"Ongoing",provinces:[]},
  {bank:"First National",type:"Switch",badge:"🔄 Switch Offer",color:"#1a3a5c",textColor:"#fff",offer:"No-Fee Mortgage Switch",detail:"Switch your mortgage to First National at renewal with no switch fees. Access competitive rates and flexible prepayment options up to 20% annually.",expires:"Ongoing",url:"https://www.firstnational.ca",tag:"Ongoing",provinces:[]},
  // Ontario
  {bank:"Meridian Credit Union",type:"First-Time Buyer",badge:"🏡 First-Time Buyer",color:"#16a34a",textColor:"#fff",offer:"First Home Advantage Package",detail:"Meridian's First Home Advantage includes a dedicated advisor, rate hold for 120 days, free financial planning session, and preferred rates for qualifying first-time buyers in Ontario.",expires:"Ongoing",url:"https://www.meridiancu.ca",tag:"Ontario Only",provinces:["ON"]},
  {bank:"DUCA Credit Union",type:"Rate",badge:"📉 Rate Special",color:"#0891b2",textColor:"#fff",offer:"Competitive Rates + Member Dividends",detail:"DUCA members earn annual dividends on their mortgage — effectively reducing your net mortgage cost. Available to Ontario residents.",expires:"Ongoing",url:"https://www.duca.com",tag:"Ontario Only",provinces:["ON"]},
  // Alberta
  {bank:"ATB Financial",type:"New Purchase",badge:"🏠 Alberta Exclusive",color:"#1a3a5c",textColor:"#fff",offer:"Alberta-Only Mortgage Rates",detail:"ATB Financial is exclusively available to Albertans. Crown corporation status means competitive rates and deep local market knowledge in Calgary, Edmonton, and beyond.",expires:"Ongoing",url:"https://www.atb.com",tag:"Alberta Only",provinces:["AB"]},
  {bank:"Servus Credit Union",type:"Switch",badge:"🔄 Switch Offer",color:"#c8102e",textColor:"#fff",offer:"Switch to Servus — No Fees",detail:"Alberta's largest credit union offers no-fee mortgage switches and competitive rates exclusively for Alberta residents. Member-owned means profits stay in the community.",expires:"Ongoing",url:"https://www.servus.ca",tag:"Alberta Only",provinces:["AB"]},
  // Manitoba
  {bank:"Assiniboine Credit Union",type:"First-Time Buyer",badge:"🏡 Manitoba Exclusive",color:"#16a34a",textColor:"#fff",offer:"ACU First Home Program",detail:"Assiniboine Credit Union offers dedicated first-time buyer support, competitive mortgage rates, and financial planning for Manitoba homebuyers. Member-owned since 1943.",expires:"Ongoing",url:"https://www.assiniboine.mb.ca",tag:"Manitoba Only",provinces:["MB"]},
  {bank:"Steinbach Credit Union",type:"Rate",badge:"📉 Rate Special",color:"#0d2240",textColor:"#fff",offer:"SCU Competitive Mortgage Rates",detail:"Steinbach Credit Union consistently offers some of Manitoba's most competitive mortgage rates. Available across Manitoba with strong digital banking tools.",expires:"Ongoing",url:"https://www.steinbachcu.com",tag:"Manitoba Only",provinces:["MB"]},
  // BC
  {bank:"Vancity Credit Union",type:"New Purchase",badge:"🏠 BC Exclusive",color:"#00573f",textColor:"#fff",offer:"Vancity Bright Side Mortgage",detail:"Vancity offers green home mortgages with preferred rates for energy-efficient homes in BC. Canada's largest community credit union with $35B in assets.",expires:"Ongoing",url:"https://www.vancity.com",tag:"BC Only",provinces:["BC"]},
  ...
  // Nova Scotia
  {bank:"East Coast Credit Union",type:"First-Time Buyer",badge:"🏡 NS Exclusive",color:"#c8102e",textColor:"#fff",offer:"NS 2% Down Payment Pilot",detail:"Nova Scotia's 2026 pilot program reduces minimum down payment to 2% for qualifying buyers. East Coast Credit Union can help you access this program.",expires:"2026 Pilot",url:"https://www.eastcoastcu.ca",tag:"NS Only",provinces:["NS"]},
];
const PT_RATES={
